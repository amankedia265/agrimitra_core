...
def main():
    ...
    dataset_name = "mandi_prices_2020_onwards"
    
    folder_path = 'data_science/utils/data'
    ...
    for filepath in csv_files:
        # Load the data district-wise
        print(f"Loading table for {filepath}")
        load_csv_to_bigquery(data_project_id,
                            dataset_name,
                            filepath.split('/')[-1].split('.')[0].split('(')[0],
                            filepath)
